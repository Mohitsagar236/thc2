...
export function HeroSection() {
  ...
  return (
    <section className="mt-5" aria-labelledby="hero-section-title">
      <SectionFrame className="md:p-8">
        ...
        <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          <article className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg)] p-3 shadow-sm">
