  ...
  return (
    <div className="flex w-full flex-col gap-2 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-3 md:min-w-[360px] md:flex-row md:items-center md:gap-3">
      <div className="md:min-w-[115px]">
        ...
        <p
          id="theme-select-status"
          className="m-0 mt-1 text-xs text-[var(--color-text-muted)]"
        >
          Active theme: {activeTheme?.meta.label || currentTheme}
        </p>
      </div>
      <select
        id="theme-select"
        ...
        aria-describedby="theme-select-status"
      >
        {themes.map((theme) => (
