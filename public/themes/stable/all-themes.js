(function (global) {
  ...
  const themeCatalogue = {
    version: "2.2.0",
    timestamp: "2026-04-29T06:31:50.916Z",
    defaults: {
      light: "light",
      dark: "dark",
    },
    themes: [
      ...
      },
      {
        ...
        meta: {
          label: "Ocean",
          description: "Ocean-inspired palette with top navigation layout",
          category: "custom",
        },
        tokens: {
      ...
      },
      {
        ...
        meta: {
          label: "Light Compact",
          description: "Compact density layout for information-rich screens",
          category: "compact",
        },
        tokens: {
          "color-primary": "#2563EB",
